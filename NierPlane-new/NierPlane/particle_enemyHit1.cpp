...
void particle_enemyHit1::showParticle() {
	if (aliveLoopIndex > aliveLoopNum)this->~particle_enemyHit1();
...
particle_enemyHit1::particle_enemyHit1(int _aliveLoopNum, int _x, int _y) {
	particleCount++;
...
particle_enemyHit1::~particle_enemyHit1() {
